...
$sql = mysqli_query($cx, "SELECT * FROM funcionariofilho") or die( 
  mysqli_error($cx) //caso haja um erro na consulta 
);

$sqlConsulta = mysqli_query($cx, "SELECT count(*) FROM funcionariofilho") or die( 
  mysqli_error($cx) //caso haja um erro na consulta 
);
        ...
        <table width="50%" border="1">
            <thead>
                <tr>
					...
					<th>Codigo Funcionario Filho</th>
            ...
            <tbody>
                ...
                <tr><?php
					...
					while($aux = mysqli_fetch_assoc($sql)) { ?>
					 ...
					 <th> <?php echo $aux["CodFuncionarioFilho"]."<br />"; ?> </th>
					 <th> <?php echo $aux["CodFuncionario"]."<br />"; ?> </th>
					  <th> <?php echo $aux["Nome"]."<br />"; ?> </th>
					  <th> <?php echo $aux["DataDeNascimento"]."<br />"; ?> </th><p>
